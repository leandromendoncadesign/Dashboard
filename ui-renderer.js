...
export function renderPlanningLists() {
    ...
    faturasContainer.innerHTML = faturas.length > 0 ? faturas.map((item) => {
        const originalIndex = despesas.findIndex(d => d === item);
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="card-details" style="background: transparent; padding: 0; margin-top: 16px;">
                ...
                <div class="detail-row"><span class="label"><i class="fa-solid fa-building-columns"></i> Conta</span><span class="value">${account?.name || 'N/A'}</span></div>
